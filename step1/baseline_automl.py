...
# Function to update the results CSV file with enhanced metrics
...
def main(args):
    ...
    print("DevLabel shape:", DevLabel.shape)

    # Train the model using FLAML AutoML
    automl = AutoML()
    automl_settings = {
        "time_budget": 36000,
        "metric": "roc_auc_weighted",  # Use the metric provided via command-line
        "task": "classification",
    ...
    update_results_csv(
        parent_dir, args.model_type, args.fps_type, prauc, roc_auc, "roc_auc_weighted",
