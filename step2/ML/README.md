# STEP 2 — Machine Learning Part

The machine learning half of Step 2. For the background and how this fits together with docking, see [`../README.md`](../README.md); for the docking pipeline itself, see [`../docking/`](../docking/).

## Overview
Step 2 systematically explores the interaction between molecular fingerprints and machine learning frameworks under class imbalance conditions, integrating AutoML with state-of-the-art imbalanced learning approaches. The models here rely exclusively on molecular fingerprints — SMILES strings are not available for the training set. The objective is to maximize predictive performance while ensuring that selected compounds are both structurally diverse and chemically plausible. This part of the pipeline is organized into four interrelated parts:
...
4. **Part 4**: Test set prediction generation
...
## Part 4: Test Set Prediction Generation

**Note**: Part 4 should be easy to be implemented by users themselves.